...
const programmeEvents = [
  event('2024-11-27', '20:15', '20:30', 'Baltic Princess lähtee Turusta', 'Baltic Princess', 'tuplis', 'Tuplis-risteily alkaa.'),
  event('2024-11-27', '20:30', '23:00', 'Beer Pongia', 'Klubi', 'tuplis', 'Beer Pong Turun järjestämää Beer Pong -ohjelmaa.'),
  event('2024-11-27', '23:00', '00:00', 'Tupliksen iltastartti', 'Klubi', 'tuplis', 'Kisailuja ja rahanarvoisia etuja.'),
  event('2024-11-28', '00:00', '04:30', 'Laivan DJ', 'Klubi', 'tuplis', 'Laivan DJ soittaa Klubilla.'),
  event('2024-11-28', '12:00', '13:00', 'Kaalimato Bingo', 'Starlight', 'tuplis', 'Bingo-ohjelmaa Starlightissa.'),
  event('2024-11-28', '13:00', '14:00', 'Pubivisa by After Lecture', 'Starlight', 'tuplis', 'After Lecturen järjestämä pubivisa Starlightissa.'),
  event('2024-11-28', '18:30', '18:45', 'Baltic Princess saapuu Turkuun', 'Baltic Princess', 'tuplis', 'Tuplis-risteily päättyy Turussa.'),
  event('2024-11-28', '19:30', '19:45', 'Baltic Princess lähtee Turusta', 'Baltic Princess', 'jouluristeily', 'Jouluristeily alkaa.'),
  event('2024-11-28', '20:00', '22:00', 'UV-maalit ja timantit', 'Piano Bar', 'jouluristeily', 'UV-maalauksia ja timantteja Piano Barissa.'),
  event('2024-11-28', '20:00', '22:00', 'Star Image -valokuvausseinä', 'Info, kansi 6', 'jouluristeily', 'Virallinen valokuvausseinä Infon edessä.'),
  event('2024-11-28', '20:00', '22:00', 'Beer Pong Turku', 'Iskelmäbaari', 'jouluristeily', 'Beer Pong Turun järjestämää Beer Pong -ohjelmaa.'),
  event('2024-11-28', '20:15', '21:00', 'Trubaduuri Teppo Tuomisto', 'Sea Pub', 'jouluristeily', 'Trubaduuri Teppo Tuomisto esiintyy Sea Pubissa.'),
  event('2024-11-28', '20:30', '22:30', 'Ständit', 'Starlightin edusta ja Piano Bar', 'jouluristeily', 'Tutustu järjestöjen ja yhteistyökumppaneiden ständeihin.'),
  event('2024-11-28', '21:00', '22:00', 'Musavisailu', 'Sea Pub', 'jouluristeily', 'Musavisailua Sea Pubissa.'),
  event('2024-11-28', '21:00', '00:15', 'Pianisti Antonia & Diamonds', 'Piano Bar', 'jouluristeily', 'Pianisti Antonia ja lauluryhmä Diamonds viihdyttävät matkustajia.'),
  event('2024-11-28', '22:00', '22:30', 'Avajaisshow', 'Starlight', 'jouluristeily', 'Jouluristeilyn avajaisshow Starlightissa.'),
  event('2024-11-28', '22:00', '00:00', 'Trubaduuri Teppo Tuomisto', 'Sea Pub', 'jouluristeily', 'Trubaduuri Teppo Tuomisto esiintyy Sea Pubissa.'),
  event('2024-11-28', '22:00', '01:00', 'Karaoke', 'Iskelmäbaari', 'jouluristeily', 'Karaoke raikaa Iskelmäbaarissa.'),
  event('2024-11-28', '22:30', '22:45', 'Tanssiryhmä The Honeys', 'Starlight', 'jouluristeily', 'Tanssiryhmä The Honeys esiintyy Starlightissa.'),
  event('2024-11-28', '22:45', '00:00', 'HybridiSpeksin bilebändi', 'Starlight', 'jouluristeily', 'HybridiSpeksin bilebändi esiintyy Starlightissa.'),
  event('2024-11-29', '00:00', '04:30', 'DJ Eiestoi', 'Klubi', 'jouluristeily', 'DJ Eiestoi starttaa bileet Klubilla.'),
  event('2024-11-29', '00:30', '01:30', 'Karri Koira', 'Kansi 10', 'jouluristeily', 'Illan pääartisti Karri Koira.'),
  event('2024-11-29', '02:00', '04:30', 'DJ PikkuMiska', 'Starlight', 'jouluristeily', 'DJ PikkuMiska pitää bileet käynnissä yön pikkutunneille asti.'),
  event('2024-11-29', '13:00', '15:00', 'Ständit', 'Starlightin edusta ja Piano Bar', 'jouluristeily', 'Tutustu järjestöjen ja yhteistyökumppaneiden ständeihin.'),
  event('2024-11-29', '13:00', '15:00', 'Eeppinen YouTube-korneri', 'Starlight', 'jouluristeily', 'Eeppinen YouTube-korneri Starlightissa.'),
  event('2024-11-29', '13:00', '15:00', 'Peliluola', 'Kokousosasto, kansi 5', 'jouluristeily', 'Pelaamista kokousosastolla.'),
  event('2024-11-29', '13:00', '16:00', 'Ennustaja Esmeralda', 'Piano Bar', 'jouluristeily', 'Ennustaja Esmeralda Piano Barissa.'),
  event('2024-11-29', '13:30', '15:15', 'Pianisti Antonia', 'Piano Bar', 'jouluristeily', 'Pianisti Antonia viihdyttää matkustajia.'),
  event('2024-11-29', '14:00', '16:00', 'Karaoke', 'Iskelmäbaari', 'jouluristeily', 'Karaoke raikaa Iskelmäbaarissa.'),
  event('2024-11-29', '14:00', '16:00', 'BITSIT!', 'Kokousosasto, kansi 5', 'jouluristeily', 'BITSIT! on ennakkoon ilmoittautuneille.'),
  event('2024-11-29', '14:15', '16:00', 'Trubaduuri Teppo Tuomisto', 'Sea Pub', 'jouluristeily', 'Trubaduuri Teppo Tuomisto esiintyy Sea Pubissa.'),
  event('2024-11-29', '15:00', '16:00', 'Kaalimato Bingo', 'Starlight', 'jouluristeily', 'Bingo-ohjelmaa Starlightissa.'),
  event('2024-11-29', '16:15', '18:00', 'Laivan bilebändi Sallad', 'Starlight', 'jouluristeily', 'Laivan bilebändi Sallad esiintyy Starlightissa.'),
  event('2024-11-29', '18:30', '18:45', 'Baltic Princess saapuu Turkuun', 'Baltic Princess', 'jouluristeily', 'Jouluristeily päättyy Turussa.'),
